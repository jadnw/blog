...
const AdjacentsNav = ({
  ...
  <div className="mt-4 py-4 flex flex-col items-stretch space-y-2 border-t border-ink-400 text-ink-500 dark:text-ink-400">
    {prev && (
      <div className="flex items-center justify-between">
        <Link href={`/${route}/${prev.slug}`}>
          <a className="flex items-center font-medium hover:text-ink-900 dark:hover:text-white duration-75">
