    ...
    <Layout title={title}>
      <article className="mx-auto py-12 px-4 lg:px-0 w-full lg:w-wrapper">
        <div className="pb-4 text-center font-bold text-3xl border-b border-ink-200 dark:border-ink-600">
          ...
          <div className="mx-auto w-full md:w-content grid grid-cols-2 gap-4 sm:gap-0 sm:flex sm:items-center sm:justify-between text-sm font-medium text-ink-400 text-left">
