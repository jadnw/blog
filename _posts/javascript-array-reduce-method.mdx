...
image: /static/how-to-use-reduce-in-javascript.png
date: 2022-05-22
tags:
  - JavaScript
draft: false
summary: The reduce function of an array is one of the most versatile functions in JavaScript. With it you can accomplish a lot of the functions from array and math objects.
---
...
![Hello](/static/how-to-use-reduce-in-javascript.png)
...
```js:lib/reduce.js {1,3-4} showLineNumbers
