---
title: How To Do Something Awesome
image: /static/how-does-swr-work.png
date: 2022-05-25
tags:
  - Next
  - React
draft: false
summary: SWR is a great package from Zeit to help make it easier to fetch remote data with hooks. It is based on the stale-while-revalidate RFC.
---
...
Code is available at: [leighhalliday/crime-mapping](https://github.com/leighhalliday/crime-mapping)
